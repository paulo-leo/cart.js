...
CART.addItem = function(values)
{
   ...
   let qtd = values.qtd != undefined ? values.qtd : 1;

   let discount = values.discount != undefined ? values.discount : 0;
   let taxa = values.taxa != undefined ? values.taxa : 0;
...
CART.total = function()
{
    ...
    return {total:total,qtd:qtd,taxa:taxa,discount:discount};
};
